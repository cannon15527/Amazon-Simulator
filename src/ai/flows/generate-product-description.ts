'use server';
/**
 * @fileOverview An AI agent that generates whimsical and humorous product descriptions.
 *
...
const GenerateProductDescriptionInputSchema = z.object({
  productName: z.string().describe('The name of the virtual product.'),
  productCategory: z.string().describe('The category of the virtual product.'),
});
...
const GenerateProductDescriptionOutputSchema = z.object({
  description: z
    .string()
    .describe('A whimsical and humorous description for the product.'),
});
